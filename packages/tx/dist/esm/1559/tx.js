import { BIGINT_0, EthereumJSErrorWithoutCode, MAX_INTEGER, bigIntToHex, bigIntToUnpaddedBytes, bytesToBigInt, toBytes, } from '@ethereumjs/util';
...
export class FeeMarket1559Tx {
    ...
    constructor(txData, opts = {}) {
        ...
        this.type = TransactionType.FeeMarketEIP1559; // 1559 tx type
        this.cache = {};
        /**
