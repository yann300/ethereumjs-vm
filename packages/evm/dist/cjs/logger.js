...
exports.EVMPerformanceLogger = exports.Timer = void 0;
...
class EVMPerformanceLogger {
    ...
    startTimer(tag) {
        if (this.currentTimer !== undefined) {
            throw (0, util_1.EthereumJSErrorWithoutCode)('Cannot have two timers running at the same time');
        }
    ...
    pauseTimer() {
        ...
        if (timer === undefined) {
            throw (0, util_1.EthereumJSErrorWithoutCode)('No timer to pause');
        }
        timer.pause();
    ...
    unpauseTimer(timer) {
        if (this.currentTimer !== undefined) {
            throw (0, util_1.EthereumJSErrorWithoutCode)('Cannot unpause timer: another timer is already running');
        }
        timer.unpause();
    ...
    stopTimer(timer, gasUsed, targetTimer = 'opcodes', staticGas, dynamicGas) {
        if (this.currentTimer === undefined || this.currentTimer !== timer) {
            throw (0, util_1.EthereumJSErrorWithoutCode)('Cannot stop timer: another timer is already running');
        }
...
exports.EVMPerformanceLogger = EVMPerformanceLogger;
