        ...
        if (this.common.isActivatedEIP(6800) || this.common.isActivatedEIP(7864)) {
            ...
            for (const m of mandatory) {
                if (!(m in this.stateManager)) {
                    throw (0, util_1.EthereumJSErrorWithoutCode)(`State manager used must implement ${m} if Verkle (EIP-6800) is activated`);
                }
            }
        }
    ...
    async _executeCall(message) {
        ...
        if (this.common.isActivatedEIP(6800) || this.common.isActivatedEIP(7864)) {
            if (message.accessWitness === undefined) {
                throw (0, util_1.EthereumJSErrorWithoutCode)('accessWitness is required for EIP-6800 & EIP-7864');
            }
