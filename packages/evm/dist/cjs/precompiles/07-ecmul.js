...
function precompile07(opts) {
    ...
    if (opts._debug !== undefined) {
        opts._debug(`Run ECMUL (0x07) precompile data=${(0, util_1.short)(opts.data)} length=${opts.data.length} gasLimit=${opts.gasLimit} gasUsed=${gasUsed}`);
    }
    ...
    const returnData = (0, util_1.hexToBytes)(opts._EVM['_bn128'].ec_mul(inputData));
    ...
    if (opts._debug !== undefined) {
        opts._debug(`ECMUL (0x07) return value=${(0, util_1.bytesToHex)(returnData)}`);
    }
    return {
