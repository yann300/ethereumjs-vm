...
async function precompile0e(opts) {
    const pName = (0, index_ts_2.getPrecompileName)('10');
    ...
    const gasUsed = (0, index_ts_1.msmGasUsed)(numPairs, gasUsedPerPair, index_ts_1.BLS_GAS_DISCOUNT_PAIRS_G2);
    if (!(0, util_ts_1.gasLimitCheck)(opts, gasUsed, pName)) {
        return (0, evm_ts_1.OOGResult)(opts.gasLimit);
    }
    if (!(0, util_ts_1.moduloLengthCheck)(opts, 288, pName)) {
