...
exports.handlers = new Map([
    ...
    [
        ...
        function (runState, common) {
            ...
            const r = BigInt((0, util_1.bytesToHex)((common.customCrypto.keccak256 ?? keccak_js_1.keccak256)(data)));
            runState.stack.push(r);
        },
    ],
    ...
    [
        ...
        function (runState) {
            ...
            const toDup = Number((0, util_1.bytesToBigInt)(runState.code.subarray(runState.programCounter, runState.programCounter + 1))) + 1;
    ...
    [
        ...
        function (runState) {
            ...
            const toSwap = Number((0, util_1.bytesToBigInt)(runState.code.subarray(runState.programCounter, runState.programCounter + 1))) + 1;
    ...
    [
        ...
        function (runState) {
            ...
            const toExchange = Number((0, util_1.bytesToBigInt)(runState.code.subarray(runState.programCounter, runState.programCounter + 1)));
