...
async function eip7702GasCost(runState, common, address, charge2929Gas) {
    ...
    if ((0, util_1.equalsBytes)(code.slice(0, 3), types_ts_1.DELEGATION_7702_FLAG)) {
        return (0, EIP2929_ts_1.accessAddressEIP2929)(runState, code.slice(3, 24), common, charge2929Gas);
    }
...
exports.dynamicGasHandlers = new Map([
    ...
    [
        ...
        async function (runState, gas, common) {
            ...
            const currentStorage = (0, util_ts_1.setLengthLeftStorage)(await runState.interpreter.storageLoad(keyBytes));
            const originalStorage = (0, util_ts_1.setLengthLeftStorage)(await runState.interpreter.storageLoad(keyBytes, true));
    ...
    [
        ...
        async function (runState, gas, common) {
            ...
            if (common.isActivatedEIP(2929)) {
                gas += (0, EIP2929_ts_1.accessAddressEIP2929)(runState, toAddress.bytes, common, charge2929Gas);
            }
            ...
            if (common.gteHardfork(common_1.Hardfork.SpuriousDragon)) {
                ...
                if (deadAccount && !(value === util_1.BIGINT_0)) {
    ...
    [
        ...
        async function (runState, gas, common) {
            ...
            if (common.isActivatedEIP(2929)) {
                gas += (0, EIP2929_ts_1.accessAddressEIP2929)(runState, (0, util_ts_1.createAddressFromStackBigInt)(toAddr).bytes, common, charge2929Gas);
            }
            if (common.isActivatedEIP(7702)) {
                gas += await eip7702GasCost(runState, common, toAddress, charge2929Gas);
            }
    ...
    [
        ...
        async function (runState, gas, common) {
            ...
            if (common.isActivatedEIP(7702)) {
                gas += await eip7702GasCost(runState, common, (0, util_ts_1.createAddressFromStackBigInt)(toAddr), charge2929Gas);
            }
    ...
    [
        ...
        async function (runState, gas, common) {
            ...
            if (common.isActivatedEIP(2929)) {
                gas += (0, EIP2929_ts_1.accessAddressEIP2929)(runState, selfdestructToAddress.bytes, common, selfDestructToCharge2929Gas, true);
            }
            return gas;
        },
    ],
