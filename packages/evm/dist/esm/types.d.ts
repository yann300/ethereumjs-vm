import type { BinaryTreeAccessWitnessInterface, Common, ParamsDict, StateManagerInterface, VerkleAccessWitnessInterface } from '@ethereumjs/common';
...
export declare function isAddOpcode(customOpcode: CustomOpcode): customOpcode is AddOpcode;
/**
...
export declare class EVMMockBlockchain implements EVMMockBlockchainInterface {
    getBlock(): Promise<{
...
export declare const DELEGATION_7702_FLAG: Uint8Array<ArrayBuffer>;
export {};
