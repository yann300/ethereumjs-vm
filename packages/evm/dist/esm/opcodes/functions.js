import { Address, BIGINT_0, BIGINT_1, BIGINT_2, BIGINT_2EXP96, BIGINT_2EXP160, BIGINT_2EXP224, BIGINT_7, BIGINT_8, BIGINT_31, BIGINT_32, BIGINT_96, BIGINT_160, BIGINT_224, BIGINT_255, BIGINT_256, MAX_INTEGER_BIGINT, TWO_POW256, bigIntToAddressBytes, bigIntToBytes, bytesToBigInt, bytesToHex, bytesToInt, concatBytes, setLengthLeft, setLengthRight, } from '@ethereumjs/util';
...
export const handlers = new Map([
    ...
    [
        ...
        function (runState) {
            ...
            const toDup = Number(bytesToBigInt(runState.code.subarray(runState.programCounter, runState.programCounter + 1))) + 1;
    ...
    [
        ...
        function (runState) {
            ...
            const toSwap = Number(bytesToBigInt(runState.code.subarray(runState.programCounter, runState.programCounter + 1))) + 1;
    ...
    [
        ...
        function (runState) {
            ...
            const toExchange = Number(bytesToBigInt(runState.code.subarray(runState.programCounter, runState.programCounter + 1)));
