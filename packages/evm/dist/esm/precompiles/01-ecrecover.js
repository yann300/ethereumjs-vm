import { BIGINT_27, BIGINT_28, bytesToBigInt, bytesToHex, ecrecover, publicToAddress, setLengthLeft, setLengthRight, } from '@ethereumjs/util';
...
export function precompile01(opts) {
    ...
    try {
        if (opts._debug !== undefined) {
            opts._debug(`${pName}: PK recovery with msgHash=${bytesToHex(msgHash)} v=${bytesToHex(v)} r=${bytesToHex(r)}s=${bytesToHex(s)}}`);
        }
