...
export function precompile100(opts) {
    ...
    if (!(rBigInt > BigInt(0) && rBigInt < P256_N && sBigInt > BigInt(0) && sBigInt < P256_N)) {
        if (opts._debug !== undefined) {
            opts._debug(`${pName} failed: signature component out of bounds: r=${bytesToHex(r)}, s=${bytesToHex(s)}`);
        }
        return {
            executionGasUsed: gasUsed,
            returnValue: new Uint8Array(),
    ...
    if (!(qxBigInt >= BigInt(0) && qxBigInt < P256_P && qyBigInt >= BigInt(0) && qyBigInt < P256_P)) {
        if (opts._debug !== undefined) {
            opts._debug(`${pName} failed: public key component out of bounds: qx=${bytesToHex(qx)}, qy=${bytesToHex(qy)}`);
        }
        return {
            executionGasUsed: gasUsed,
            returnValue: new Uint8Array(),
