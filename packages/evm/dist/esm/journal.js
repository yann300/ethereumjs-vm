...
import { Address, EthereumJSErrorWithoutCode, RIPEMD160_ADDRESS_STRING, bytesToHex, bytesToUnprefixedHex, hexToBytes, stripHexPrefix, unprefixedHexToBytes, } from '@ethereumjs/util';
    ...
    touchAccount(address) {
        ...
        if (this.preimages !== undefined) {
            ...
            if (this.stateManager.getAppliedKey === undefined) {
                throw EthereumJSErrorWithoutCode('touchAccount: stateManager.getAppliedKey can not be undefined if preimage storing is enabled');
            }
