...
import { Account, Address, BIGINT_0, BIGINT_1, EthereumJSErrorWithoutCode, KECCAK256_NULL, KECCAK256_RLP, MAX_INTEGER, bigIntToBytes, bytesToUnprefixedHex, createZeroAddress, equalsBytes, generateAddress, generateAddress2, short, } from '@ethereumjs/util';
        ...
        if (this.common.isActivatedEIP(6800) || this.common.isActivatedEIP(7864)) {
            ...
            for (const m of mandatory) {
                if (!(m in this.stateManager)) {
                    throw EthereumJSErrorWithoutCode(`State manager used must implement ${m} if Verkle (EIP-6800) is activated`);
                }
            }
        }
