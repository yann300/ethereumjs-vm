import { Blob4844Tx, Capability, isAccessList2930Tx, isBlob4844Tx, isFeeMarket1559Tx, isLegacyTx, } from '@ethereumjs/tx';
import { Account, Address, BIGINT_0, BIGINT_2, EthereumJSErrorWithoutCode, bytesToHex, bytesToUnprefixedHex, equalsBytes, hexToBytes, } from '@ethereumjs/util';
...
export class TxPool {
    ...
    pruneBlobsAndProofsCache() {
        ...
        const pruneLength = this.blobsAndProofsByHash.size - allowedBlobsPerBlock * this.config.blobsAndProofsCacheBlocks;
        let pruned = 0;
