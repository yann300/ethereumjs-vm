...
export declare class TxPool {
    ...
    blobAndProofByHash: Map<PrefixedHexString, {
        blob: PrefixedHexString;
        proof: PrefixedHexString;
    }>;
    blobAndProofsByHash: Map<PrefixedHexString, {
        blob: PrefixedHexString;
     ...
     */
    removeByHash(txHash: UnprefixedHash, tx?: any): void;
    /**
