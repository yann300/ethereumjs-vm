 ...
 */
export function inspectParams(params, shorten) {
...
export function createRPCServer(manager, opts) {
...
function checkHeaderAuth(req, jwtSecret) {
    ...
    const claims = decode(token.trim(), jwtSecret, false, algorithm);
...
export function createRPCServerListener(opts) {
...
export function createWsRPCServerListener(opts) {
    const { server, withEngineMiddleware, RPCCors } = opts;
