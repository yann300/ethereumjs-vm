 ...
 * @param block
 */
export async function debugCodeReplayBlock(execution, block) {
    const code = `
/**
...
const main = async () => {
  ...
  stateManager.setStateRoot(hexToBytes('${bytesToHex(await execution.vm.stateManager.getStateRoot())}'))
