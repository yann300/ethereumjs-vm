import { type Peer } from './peer/index.ts';
...
export declare class PeerPool {
     ...
     */
    private DEFAULT_PEER_BEST_HEADER_UPDATE_INTERVAL;
    private _statusCheckInterval;
    private _peerBestHeaderUpdateInterval;
     ...
     */
    _peerBestHeaderUpdate(): Promise<void>;
}
