...
import { RlpxPeer } from "./peer/index.js";
/**
 * @module net
 */
/**
...
export class PeerPool {
    ...
    constructor(options) {
         ...
         */
        this.DEFAULT_PEER_BEST_HEADER_UPDATE_INTERVAL = 5000;
    ...
    async start() {
        ...
        this._statusCheckInterval = setInterval(await this._statusCheck.bind(this), this.DEFAULT_STATUS_CHECK_INTERVAL);
        this._peerBestHeaderUpdateInterval = setInterval(await this._peerBestHeaderUpdate.bind(this), this.DEFAULT_PEER_BEST_HEADER_UPDATE_INTERVAL);
        this.running = true;
        return true;
    }
    /**
    ...
    async stop() {
        ...
        clearInterval(this._peerBestHeaderUpdateInterval);
