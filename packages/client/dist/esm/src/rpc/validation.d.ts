 ...
 */
export declare function middleware(method: any, requiredParamsCount: number, validators?: any[], names?: string[]): RPCMethod;
/**
 * @memberof module:rpc
 */
export declare const validators: {
    ...
    readonly bytes96: (params: any[], index: number) => {
        code: number;
        message: string;
    } | undefined;
     ...
     * @param index index of parameter
     */
    readonly ipv4Address: (params: any[], index: number) => {
        code: number;
        message: string;
    } | undefined;
    /**
    ...
    readonly depositRequest: (requiredFields?: string[]) => (params: any[], index: number) => any;
    readonly withdrawalRequest: (requiredFields?: string[]) => (params: any[], index: number) => any;
    readonly consolidationRequest: (requiredFields?: string[]) => (params: any[], index: number) => any;
    /**
