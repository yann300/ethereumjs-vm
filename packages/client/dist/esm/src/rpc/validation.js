 ...
 */
export function middleware(method, requiredParamsCount, validators = [], names = []) {
...
export const validators = {
    ...
    get bytes96() {
        return (params, index) => bytes(96, params, index);
    },
    get bytes256() {
    ...
    get withdrawalRequest() {
        return (requiredFields = ['sourceAddress', 'validatorPubkey', 'amount']) => {
            return (params, index) => {
                if (typeof params[index] !== 'object') {
                    return {
                        code: INVALID_PARAMS,
    ...
    get consolidationRequest() {
        return (requiredFields = ['sourceAddress', 'sourcePubkey', 'targetPubkey']) => {
            return (params, index) => {
                if (typeof params[index] !== 'object') {
                    return {
                        code: INVALID_PARAMS,
