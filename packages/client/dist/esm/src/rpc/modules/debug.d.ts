...
export declare class Debug {
     ...
     */
    traceTransaction(params: [PrefixedHexString, tracerOpts]): Promise<{
        gas: string;
        returnValue: string;
        failed: boolean;
     ...
     */
    storageRangeAt(params: [PrefixedHexString, number, PrefixedHexString, PrefixedHexString, number]): Promise<import("@ethereumjs/common").StorageRange>;
    /**
     * Returns an RLP-encoded block
     * @param blockOpt Block number or tag
     */
    getRawBlock(params: [string]): Promise<`0x${string}`>;
    /**
     * Returns an RLP-encoded block header
     * @param blockOpt Block number or tag
     * @returns
     */
    getRawHeader(params: [string]): Promise<`0x${string}`>;
    /**
     * Returns an array of EIP-2718 binary-encoded receipts
     * @param blockOpt Block number or tag
     */
    getRawReceipts(params: [string]): Promise<`0x${string}`[]>;
    /**
     * Returns the bytes of the transaction.
     * @param blockOpt Block number or tag
     */
    getRawTransaction(params: [PrefixedHexString]): Promise<`0x${string}` | null>;
    /**
     * Sets the verbosity level of the client logger
     * @param level logger level to use with 0 as the lowest verbosity
     */
    verbosity(params: [number]): Promise<string>;
    /**
     ...
     */
    setHead(params: [string]): Promise<void>;
}
