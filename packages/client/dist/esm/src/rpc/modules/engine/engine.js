...
export class Engine {
    ...
    initValidators() {
        ...
        this.getPayloadV5 = cmMiddleware(middleware(callWithStackTrace(this.getPayloadV5.bind(this), this._rpcDebug), 1, [
            [validators.bytes8],
        ]), () => this.connectionManager.updateStatus());
        /**
        ...
        this.getBlobsV2 = cmMiddleware(middleware(callWithStackTrace(this.getBlobsV2.bind(this), this._rpcDebug), 1, [
            [validators.array(validators.bytes32)],
        ]), () => this.connectionManager.updateStatus());
    }
    /**
