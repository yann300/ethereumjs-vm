import { type Bytes8, type Bytes32, type ExecutionPayloadV1, type ExecutionPayloadV2, type ExecutionPayloadV3, type PayloadStatusV1 } from './types.ts';
...
export declare class Engine {
    ...
    newPayloadV4(params: [ExecutionPayloadV3, Bytes32[], Bytes32, Bytes32[]]): Promise<PayloadStatusV1>;
    /**
    ...
    getPayloadV3(params: [Bytes8]): Promise<{
        ...
        blockValue: `0x${string}`;
        blobsBundle: import("./types.ts").BlobsBundleV1OrV2 | undefined;
        shouldOverrideBuilder: boolean;
    }>;
    getPayloadV4(params: [Bytes8]): Promise<{
        executionPayload: ExecutionPayload;
        executionRequests: string[] | undefined;
        blockValue: `0x${string}`;
        blobsBundle: import("./types.ts").BlobsBundleV1OrV2 | undefined;
    ...
    getPayloadV5(params: [Bytes8]): Promise<{
        executionPayload: ExecutionPayload;
        executionRequests: string[] | undefined;
        blockValue: `0x${string}`;
        blobsBundle: import("./types.ts").BlobsBundleV1OrV2 | undefined;
