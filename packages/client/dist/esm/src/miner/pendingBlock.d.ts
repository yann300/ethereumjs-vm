...
export declare class PendingBlock {
    ...
    executionRequests: Map<string, CLRequest<CLRequestType>[]>;
     ...
     */
    start(vm: VM, parentBlock: Block, headerData?: Partial<HeaderData>, withdrawals?: WithdrawalData[]): Promise<Uint8Array<ArrayBufferLike>>;
    /**
     ...
     */
    build(payloadIdBytes: Uint8Array | string): Promise<void | [
        block: Block,
        receipts: TxReceipt[],
        value: bigint,
        blobs?: BlobsBundle,
