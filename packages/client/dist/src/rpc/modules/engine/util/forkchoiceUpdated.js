...
exports.pruneCachedBlocks = void 0;
const pruneCachedBlocks = (chain, chainCache) => {
    ...
    if (finalized !== null) {
        ...
        if (vm !== null) {
            const pruneExecutedBlocksTill = vm.header.number < finalized.header.number ? vm.header.number : finalized.header.number;
...
exports.pruneCachedBlocks = pruneCachedBlocks;
//# sourceMappingURL=forkchoiceUpdated.js.map