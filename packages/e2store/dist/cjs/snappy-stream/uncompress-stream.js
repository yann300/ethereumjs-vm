...
class UncompressStream extends stream_1.Transform {
    ...
    getType(value) {
        ...
        if (value === 0xfe)
            return 'padding';
        throw (0, rlp_1.EthereumJSErrorWithoutCode)('unknown frame type');
    }
    concatBuffers() {
    ...
    _parse(callback) {
        ...
        if (type === 'compressed') {
            ...
            try {
                const raw = (0, snappyjs_1.uncompress)(data.slice(4));
                this.push(raw);
...
//# sourceMappingURL=uncompress-stream.js.map