...
const ssz_js_1 = require("micro-eth-signer/ssz.js");
...
const sszHeader = (0, ssz_js_1.bytelist)(MAX_HEADER_LENGTH);
const sszProof = (0, ssz_js_1.bytelist)(MAX_HEADER_PROOF_LENGTH);
exports.sszHeaderWithProof = (0, ssz_js_1.container)({
    header: sszHeader,
    proof: sszProof,
});
