 ...
 * @param end Number
 */
export declare function getSeed(seed: Uint8Array, begin: number, end: number): Uint8Array<ArrayBufferLike>;
export declare function fnv(x: number, y: number): number;
export declare function fnvBytes(a: Uint8Array, b: Uint8Array): Uint8Array<ArrayBuffer>;
