...
class LeafVerkleNode extends baseVerkleNode_ts_1.BaseVerkleNode {
    constructor(options) {
        super(options);
        this.type = types_ts_1.VerkleNodeType.Leaf;
        this.stem = options.stem;
        this.values = options.values ?? (0, util_ts_1.createDefaultLeafVerkleValues)();
        this.c1 = options.c1;
        this.c2 = options.c2;
    }
    /**
        ...
        if (values !== undefined) {
            values = values.map((el) => {
                ...
                if (el instanceof Uint8Array && (0, util_1.equalsBytes)(el, new Uint8Array(32)))
                    return types_ts_1.LeafVerkleNodeValue.Deleted;
                return el;
            });
        }
        else
            values = (0, util_ts_1.createDefaultLeafVerkleValues)();
        const c1Values = (0, util_ts_1.createCValues)(values.slice(0, 128));
        const c2Values = (0, util_ts_1.createCValues)(values.slice(128));
    ...
    static fromRawNode(rawNode, verkleCrypto) {
        ...
        if (nodeType !== types_ts_1.VerkleNodeType.Leaf) {
        ...
        if (rawNode.length !== types_ts_1.NODE_WIDTH + 5) {
        ...
        const values = rawNode
            ...
            .map((el) => (el.length === 0 ? 0 : (0, util_1.equalsBytes)(el, (0, util_ts_1.createZeroesLeafValue)()) ? 1 : el));
    ...
    getValue(index) {
        ...
        switch (value) {
            case types_ts_1.LeafVerkleNodeValue.Untouched:
                return undefined;
            case types_ts_1.LeafVerkleNodeValue.Deleted:
    ...
    setValue(index, value) {
        ...
        const cValues = index < 128 ? (0, util_ts_1.createCValues)(this.values.slice(0, 128)) : (0, util_ts_1.createCValues)(this.values.slice(128));
    ...
    raw() {
        return [
            new Uint8Array([types_ts_1.VerkleNodeType.Leaf]),
            this.stem,
            this.commitment,
            ...
            ...this.values.map((val) => {
                switch (val) {
                    ...
                    case types_ts_1.LeafVerkleNodeValue.Deleted:
                        return (0, util_ts_1.createZeroesLeafValue)();
                    default:
                        return val;
                }
            }),
