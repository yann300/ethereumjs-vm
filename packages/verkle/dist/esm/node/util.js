...
export const createDefaultLeafVerkleValues = () => new Array(256).fill(LeafVerkleNodeValue.Untouched);
/***
...
export const createCValues = (values) => {
    if (values.length !== 128)
        throw EthereumJSErrorWithoutCode(`got wrong number of values, expected 128, got ${values.length}`);
