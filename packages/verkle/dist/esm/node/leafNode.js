import { EthereumJSErrorWithoutCode, equalsBytes, intToBytes, setLengthRight, } from '@ethereumjs/util';
...
export class LeafVerkleNode extends BaseVerkleNode {
    constructor(options) {
        super(options);
    ...
    static async create(stem, verkleCrypto, values) {
        ...
        if (values !== undefined) {
            ...
            values = createDefaultLeafVerkleValues();
        ...
        let commitment = verkleCrypto.updateCommitment(verkleCrypto.zeroCommitment, 0, new Uint8Array(32), setLengthRight(intToBytes(1), 32));
        commitment = verkleCrypto.updateCommitment(commitment, 1, new Uint8Array(32), setLengthRight(stem, 32));
    ...
    setValue(index, value) {
        ...
        const cValues = index < 128 ? createCValues(this.values.slice(0, 128)) : createCValues(this.values.slice(128));
