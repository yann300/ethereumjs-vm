...
import { BIGINT_0, EthereumJSErrorWithoutCode, KECCAK256_RLP, KECCAK256_RLP_ARRAY, bytesToHex, equalsBytes, } from '@ethereumjs/util';
...
export class Block {
    ...
    constructor(header, transactions = [], uncleHeaders = [], withdrawals, opts = {}, executionWitness) {
        ...
        if (!this.common.isActivatedEIP(6800) &&
            ...
            throw EthereumJSErrorWithoutCode(`Cannot have executionWitness field if EIP 6800 is not active `);
        }
    ...
    async validateData(onlyHeader = false, verifyTxs = true) {
        ...
        if (this.common.isActivatedEIP(6800)) {
            ...
            if (this.executionWitness === null) {
                throw EthereumJSErrorWithoutCode(`Invalid block: ethereumjs stateless client needs executionWitness`);
            }
        }
    }
    /**
