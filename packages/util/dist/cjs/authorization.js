...
function eoaCode7702AuthorizationListJSONItemToBytes(authorizationList) {
    ...
    for (const field of requiredFields) {
        if (authorizationList[field] === undefined) {
            throw (0, errors_ts_1.EthereumJSErrorWithoutCode)(`EIP-7702 authorization list invalid: ${field} is not defined`);
        }
    }
    return [
...
function eoaCode7702AuthorizationMessageToSign(input) {
    if (Array.isArray(input)) {
        ...
        if (address.length !== 20) {
            throw (0, errors_ts_1.EthereumJSErrorWithoutCode)('Cannot sign authority: address length should be 20 bytes');
        }
