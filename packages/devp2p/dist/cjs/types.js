...
exports.ProtocolType = exports.DisconnectReasonNames = exports.DISCONNECT_REASON = void 0;
exports.DISCONNECT_REASON = {
...
exports.DisconnectReasonNames = Object.entries(exports.DISCONNECT_REASON).reduce((acc, [key, value]) => {
    acc[value] = key;
    return acc;
}, {});
