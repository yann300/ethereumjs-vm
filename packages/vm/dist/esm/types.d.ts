...
import type { EVMInterface, EVMMockBlockchainInterface, EVMOpts, EVMResult, Log } from '@ethereumjs/evm';
import type { AccessList, TypedTransaction } from '@ethereumjs/tx';
import type { BigIntLike, CLRequest, CLRequestType, PrefixedHexString, WithdrawalData } from '@ethereumjs/util';
