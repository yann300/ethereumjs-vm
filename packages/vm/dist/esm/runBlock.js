...
import { VerkleAccessWitness } from '@ethereumjs/evm';
import { MerklePatriciaTrie } from '@ethereumjs/mpt';
import { RLP } from '@ethereumjs/rlp';
import { verifyVerkleStateProof } from '@ethereumjs/statemanager';
import { TransactionType } from '@ethereumjs/tx';
import { Account, Address, BIGINT_0, BIGINT_1, BIGINT_8, EthereumJSErrorWithoutCode, GWEI_TO_WEI, KECCAK256_RLP, bigIntToAddressBytes, bigIntToBytes, bytesToHex, concatBytes, createAddressFromString, equalsBytes, hexToBytes, intToBytes, setLengthLeft, short, unprefixedHexToBytes, } from '@ethereumjs/util';
    ...
    if (generateFields) {
        ...
        if (vm.common.isActivatedEIP(6800)) {
            ...
            if ((await vm['_opts'].stateManager.verifyVerklePostState(vm.evm.verkleAccessWitness)) ===
                false) {
                throw EthereumJSErrorWithoutCode(`Verkle post state verification failed on block ${block.header.number}`);
            }
