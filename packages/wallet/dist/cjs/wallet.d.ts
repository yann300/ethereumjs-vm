...
export declare const KDFFunctions: {
    readonly PBKDF: "pbkdf2";
...
export declare class Wallet {
     ...
     */
    static fromPublicKey(publicKey: Uint8Array, nonStrict?: boolean): Wallet;
    /**
    ...
    static fromEthSale(input: string | EthSaleKeystore, password: string): Promise<Wallet>;
    /**
    ...
    getPrivateKeyString(): PrefixedHexString;
    /**
     * Returns the wallet's public key.
     */
     ...
     */
    getPublicKeyString(): PrefixedHexString;
    /**
     ...
     */
    verifyPublicKey(publicKey: Uint8Array): boolean;
}
export {};
