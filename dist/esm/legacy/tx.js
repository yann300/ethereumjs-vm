...
import { BIGINT_2, EthereumJSErrorWithoutCode, MAX_INTEGER, bigIntToHex, bigIntToUnpaddedBytes, bytesToBigInt, intToBytes, toBytes, unpadBytes, } from '@ethereumjs/util';
...
export class LegacyTx {
    ...
    constructor(txData, opts = {}) {
        ...
        this.type = TransactionType.Legacy; // Legacy tx type
        this.cache = {};
        /**
