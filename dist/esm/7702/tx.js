import { BIGINT_0, EthereumJSErrorWithoutCode, MAX_INTEGER, bigIntToHex, bigIntToUnpaddedBytes, bytesToBigInt, eoaCode7702AuthorizationListBytesItemToJSON, eoaCode7702AuthorizationListJSONItemToBytes, isEOACode7702AuthorizationList, toBytes, } from '@ethereumjs/util';
...
import { getBaseJSON, sharedConstructor, validateNotArray, valueBoundaryCheck, } from "../util/internal.js";
...
export class EOACode7702Tx {
    ...
    constructor(txData, opts = {}) {
        this.type = TransactionType.EOACodeEIP7702; // 7702 tx type
        this.cache = {};
        /**
